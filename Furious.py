...
def tool():
  ...
  def options1():
    ...
    os.system('cls' if os.name=='nt' else 'clear')
    ctypes.windll.kernel32.SetConsoleTitleW("Furious Multi Tools - by: TheAnnonymous")
    print(f'''
    {Fore.MAGENTA}                  _______           _______ _________ _______           _______ 
    {Fore.MAGENTA}                  (  ____ \|\     /|(  ____ )\__   __/(  ___  )|\     /|(  ____
    {Fore.MAGENTA}                  | (    \/| )   ( || (    )|   ) (   | (   ) || )   ( || (    \/
    {Fore.LIGHTMAGENTA_EX}                  | (__    | |   | || (____)|   | |   | |   | || |   | || (_____
    {Fore.LIGHTMAGENTA_EX}                  |  __)   | |   | ||     __)   | |   | |   | || |   | |(_____  )
    {Fore.LIGHTMAGENTA_EX}                  | (      | |   | || (\ (      | |   | |   | || |   | |      ) |
    {Fore.LIGHTMAGENTA_EX}                  | )      | (___) || ) \ \_____) (___| (___) || (___) |/\____) |
    {Fore.LIGHTMAGENTA_EX}                  |/       (_______)|/   \__/\_______/(_______)(_______)\_______)
    ''')                           
    print(Fore.MAGENTA + '╔══════════════════════════════╦══════════════════════════╦══════════════════════════════╦══════════════════════════╗')
    ...
    print(Fore.MAGENTA + '║     [01] TOKEN JOINER        ║     [09] TOKENS          ║     [15] TOKEN BRUTEFORCER   ║     [23] Informations    ║')
...
{Fore.RED} | |__| (_) | (_| | | | | |
 ...
 \033[31m| |___| | |  __/ (_| | | |_\__ \ 
  \____|_|  \___|\__,_|_|\__|___/           et informations
                                    
    ''')
    By = Fore.LIGHTBLACK_EX + 'Furious Multi Tools est un Multi Tools surpuissant!'
    Aran = Fore.MAGENTA + '---censured---'
    Tkn = Fore.RED + '---censured---'
    Vivid = Fore.CYAN + '---censured---'
...
{Fore.RED} | |_| | \__ \ (_| (_) | | | (_| | 
 |____/|_|___/\___\___/|_|  \__,_| 
  ...
  Vous voulez rejoindre notre discord ?
  [1] Non Disponible !
  [2] Non Disponible !
...
{Fore.RED}                                                    
  ...
  def aboutthis():
    cls()
    ctypes.windll.kernel32.SetConsoleTitleW("Plus d'informations")
    print(f'''
{Fore.MAGENTA}     _    _                 _   
    / \  | |__   ___  _   _| |_ 
   / _ \ | '_ \ / _ \| | | | __|
{Fore.RED}  / ___ \| |_) | (_) | |_| | |_ 
 /_/   \_\_.__/ \___/ \__,_|\__|
  {Fore.LIGHTBLUE_EX}   
  Salut! Bienvenue sur My Grabber!
  La suite, bientot!                       
    ''')
